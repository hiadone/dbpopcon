...
$route['shortcut'.'/([a-zA-Z0-9_-]+)'.'/([a-zA-Z0-9_-]+)'.'/([a-zA-Z0-9_-]+)'] = "shortcut/shortcut_info/$1/$2/$3";

$route['media/reward'.'/([0-9]+)'] = "media/reward/$1";
$route['media'.'/([a-zA-Z0-9_-]+)'.'/([a-zA-Z0-9_-]+)'] = "media/index/$1/$2";

$route['media_multiple'.'/([a-zA-Z0-9_-]+)'.'/([a-zA-Z0-9_-]+)'] = "media_multiple/index/$1/$2";
$route['media_multiple'.'/([a-zA-Z0-9_-]+)'.'/([a-zA-Z0-9_-]+)'.'/([a-zA-Z0-9_-]+)'] = "media_multiple/index/$1/$2/$3";




$route['media_write/([a-zA-Z0-9_-]+)'] = "media_board_write/write/$1";
$route['media_write/reply/([0-9]+)'] = "media_board_write/reply/$1";
$route['media_write/modify/([0-9]+)'] = "media_board_write/modify/$1";