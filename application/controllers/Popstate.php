...
class Popstate extends CB_Controller
{
     ...
     * 모델을 로딩합니다
     */
    protected $models = array('Shortcut_file_download_log','Shortcut_link_click_log', 'Board', 'Post','Post_link','Post_meta','Post_extra_vars');   
    ...
    public function index()
    {
        ...
        $view['view']['list'] = $list = $this->_get_list('campaign');
