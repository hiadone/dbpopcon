        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="topmenu-navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    $mygroup = $this->member->group();

                    $menuhtml = '';
                    if (element('menu', $layout) && $this->member->is_member()) {
                        $menu = element('menu', $layout);
                        if (element(0, $menu)) {
                            foreach (element(0, $menu) as $mkey => $mval) {

                                $groups_m = explode(",",element('men_mgrid', $mval));
                                ...
                                if ($mygroup && is_array($mygroup)) {
                                    ...
                                    foreach ($mygroup as $key => $value) {
                                        ...
                                        if (is_array($groups_m) && in_array(element('mgr_id', $value), $groups_m)) {
                                ...
                                if (element(element('men_id', $mval), $menu)) {
                                    ...
                                    foreach (element(element('men_id', $mval), $menu) as $skey => $sval) {
                                        ...
                                        $groups_s = explode(",",element('men_mgrid', $sval));
                                        ...
                                        if ($mygroup && is_array($mygroup)) {
                                            ...
                                            foreach ($mygroup as $key => $value) {
                                                ...
                                                if (is_array($groups_s) && in_array(element('mgr_id', $value), $groups_s)) {
