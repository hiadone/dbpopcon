        ...
        ?>
            <div class="box-table-header">
                <ul class="nav nav-pills">
                    <li role="presentation" class="active"><a href="<?php echo admin_url($this->pagedir); ?>">상담신청 목록</a></li>
                ...
                ?>  
                    <div class="btn-group btn-group-sm pull-right" role="group" aria-label="...">
                        <a href="<?php echo element('listall_url', $view); ?>" class="btn btn-sm <?php echo (!$this->input->get('mlh_status')) ? 'btn-success' : 'btn-default'; ?>">전체목록</a>
                        <a href="?mlh_status=1" class="btn btn-sm <?php echo ($this->input->get('mlh_status') === '1' ) ? 'btn-success' : 'btn-default'; ?>">유효 목록</a>
                        <a href="?mlh_status=2" class="btn btn-sm <?php echo ($this->input->get('mlh_status') === '2' ) ? 'btn-success' : 'btn-default'; ?>">무효 목록</a>
                    </div>
                ...
                <table class="table table-hover table-striped table-bordered">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo get_phone(element('mlh_mobileno', $result)); ?></td>
                            <td><?php echo (element('mlh_age', $result)); ?></td>
                            <!-- <td><?php echo element('mlh_gender', $result) === '1' ? '남성' : '여성'; ?></td> -->
                            ...
                            <td><a href="javascript:post_action('media_status', '<?php echo element('mlh_id', $result);?>', '<?php echo element('mlh_status', $result) ==='1' ? '2':'1';?>');" class="btn <?php echo element('mlh_status', $result) ==='1' ? 'btn-success':'btn-danger';?> btn-xs"><?php echo element('mlh_status', $result) === '1' ? '유효' : '무효'; ?></a></td>
                        </tr>
                    <?php
                        }
                    }
