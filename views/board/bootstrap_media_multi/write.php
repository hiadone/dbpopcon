...
<div class="board">
    ...
    ?>
        ...
        <div class="form-horizontal box-table">
            ...
            <?php } ?>
            <div class="form-group">
                <label for="post_title" class="col-sm-2 control-label">미디어 제목</label>
            ...
            <div class="form-group">
                <label for="post_md" class="col-sm-2 control-label">중간 관리자</label>
                <div class="col-sm-10" style="display:table;">
                    <input type="text" class="form-control" name="post_manager" id="post_manager" value="<?php echo set_value('post_manager', element('post_manager', element('post', $view))); ?>" /> 중간 관리 아이디를 콤마 (,)로 구분하여 입력하세요
                </div>
            </div>
            <?php
            ...
            */            
            ...
            ?>
                <div class="form-group">
                    <label for="<?php echo $link_column; ?>" class="col-sm-2 control-label">미디어 랜딩 URL</label>
                    <div class="col-sm-10">
