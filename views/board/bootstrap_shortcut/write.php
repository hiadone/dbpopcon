...
<div class="board">
    ...
    ?>
        ...
        <div class="form-horizontal box-table">
            ...
            <?php } ?>
            <div class="form-group">
                <label for="post_title" class="col-sm-2 control-label">숏컷 제목</label>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10" style="display:table;">
                    <input type="text" class="form-control" name="post_md" id="post_md" value="<?php echo set_value('post_md', element('post_md', element('post', $view))); ?>" /> 해당 게시판내의 고유코드로 입력
                </div>
            </div>
            <?php
            ...
            */
            ...
            ?>
                <div class="form-group">
                    <label for="<?php echo $link_column; ?>" class="col-sm-2 control-label">숏컷 랜딩 URL</label>
                    <div class="col-sm-10">
            ...
            if (element('use_upload', element('board', $view))) {
                ...
                for ($i = 0; $i < $file_count; $i++) {
                    ...
                    $thumb_url = element('thumb_url', element($i, element('file', $view)));
            ...
            ?>
                <div class="form-group">
                    <label for="<?php echo $file_column; ?>" class="col-sm-2 control-label">ICON</label>
                    <div class="col-sm-10">
                        <input type="file" class="form-control" name="<?php echo $file_column; ?>" id="<?php echo $file_column; ?>" />
                        <?php if ($download_link) { ?>
                            <!-- <a href="<?php echo $download_link; ?>"> --><img src="<?php echo $thumb_url; ?>" alt="<?php echo html_escape(element('pfi_originname', $value)); ?>" title="<?php echo html_escape(element('pfi_originname', $value)); ?>" class="view_full_image" data-origin-image-url="<?php echo element('origin_image_url', $value); ?>" style="max-width:100%;" /><!-- </a> -->
