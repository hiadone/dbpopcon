...
//     $q_c="";
// }elseif(element('post_id',element('post',$view)) === "92"){
//     $q_a=array(1=>'서울',2=>'경기',3=>'인천');
//     $q_b="";
//     $q_c="";
// } else {
        ...
        <table class="table table-hover" >
            ...
            ?>
                 <tr>
                    ...
                    <?php 
                    if (element('tenping_extra_vars', element('data', element('list', $view)))){
                        echo '<td>'.element('q_a',element('tenping_extra_vars',$result)).'</td>
                    <td>'.element('q_b',element('tenping_extra_vars',$result)).'</td>
                    <td>'.element('q_c',element('tenping_extra_vars',$result)).'</td>
                    ';
                    }
                     ?>
                    <?php
