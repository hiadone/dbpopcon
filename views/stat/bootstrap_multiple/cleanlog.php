    ...
    <?php  echo '<h4 class="highlight mb20">미디어 통계</h4>'; ?>
        <div class="box-table-header">
            <ul class="nav nav-pills">
                    <li role="presentation" ><a href="<?php echo site_url($this->pagedir.'/lists/multiple'); ?>">캠페인 목록</a></li>
                    ...
                    <li role="presentation" class="active"><a href="<?php echo site_url($this->pagedir . '/cleanlog/multiple?'.$this->param->output()); ?>">로그삭제</a></li>
                    <?php } ?>
                </ul>
        </div>
        <?php
