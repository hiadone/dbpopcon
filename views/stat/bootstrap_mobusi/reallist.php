...
<div class="box">
    <div class="box-table">
        ...
        <?php  echo '<h4 class="highlight mb20">모부시 통계</h4>'; ?>
            <div class="box-table-header">
                <ul class="nav nav-pills">
                    <li role="presentation" ><a href="<?php echo site_url($this->pagedir. '/lists/mobusi'); ?>">캠페인 목록</a></li>
                    <li role="presentation" class="active"><a href="<?php echo site_url($this->pagedir . '/real_click_list/mobusi?'.$this->param->output()); ?>">실시간 리스트</a></li>
                    <li role="presentation"><a href="<?php echo site_url($this->pagedir . '/graph/mobusi?'.$this->param->output()); ?>">기간별 그래프</a></li>
                    <?php if (element('is_admin', $view)) { ?>
                    <li role="presentation"><a href="<?php echo site_url($this->pagedir . '/cleanlog/mobusi'); ?>">로그삭제</a></li>
                    <?php } ?>
                </ul>
                <?php
                ob_start();
                ?>
                    <div class="btn-group pull-right" role="group" aria-label="...">
                        <!-- <button type="button" class="btn btn-outline btn-success btn-sm mr10" id="export_to_excel"><i class="fa fa-file-excel-o"></i> 엑셀 다운로드</button> -->
                ...
                <div class="pull-right mr10">
                    <ul class="nav nav-tabs clearfix">
                        <li role="presentation" <?php if ($this->uri->segment(2) === 'real_click_list') { ?>class="active" <?php } ?>><a href="<?php echo site_url($this->pagedir . '/real_click_list/mobusi?'.$this->param->replace('page')); ?>" >노출 통계</a></li>
                        <li role="presentation" <?php if ($this->uri->segment(2) === 'real_download_list') { ?>class="active" <?php } ?>><a href="<?php echo site_url($this->pagedir . '/real_download_list/mobusi?'.$this->param->replace('page')); ?>">클릭 통계</a></li>
                ...
                <table class="table table-hover table-striped table-bordered">
                    <thead>
                        <tr>
                            ...
                            <?php if($this->uri->segment(2) === 'real_click_list') {?>
                                <th style="width:30%;">유입 URL</th>
                            <?php } ?>
                            <th style="width:15%;">PREFIJO</th>
                            <th style="width:12%;">PIXEL</th>
                    ...
                    ?>
                        <tr>
                            ...
                            <?php if($this->uri->segment(2) === 'real_click_list') {?>
                            <td  style="word-break:break-all;"><?php if(element('mlc_referrer', $result)){ ?><i class="fa fa-link"></i><a href="<?php echo goto_url(prep_url(urldecode(element('mlc_referrer', $result)))); ?>" target="_blank"><?php echo prep_url(urldecode(element('mlc_referrer', $result))); ?></a><?php } ?></td>
                            <?php } ?>
                            <td style="word-break:break-all;"><?php echo element('prefijo', $result); ?></td>
                            <td style="word-break:break-all;"><?php echo element('pixel', $result); ?></td>
