    ...
    <?php  echo '<h4 class="highlight mb20">모부시 통계</h4>'; ?>
        <div class="box-table-header">
            <ul class="nav nav-pills">
                ...
                <li role="presentation"><a href="<?php echo site_url($this->pagedir . '/real_click_list/mobusi?'.$this->param->output()); ?>">실시간 리스트</a></li>
                <li role="presentation" class="active"><a href="<?php echo site_url($this->pagedir . '/graph/mobusi?'.$this->param->output()); ?>">기간별 그래프</a></li>
    ...
    if($this->input->get('datetype') === 'domain'){
     ...
     <?php } else {?>
        ...
        data.addRows([
            ...
            ?>',<?php echo element('hit_count', $result, 0); ?>,<?php echo element('count', $result, 0); ?>],
            <?php
                }
            }
            ?>
