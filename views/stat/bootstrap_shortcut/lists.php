        ...
        <?php  echo '<h4 class="highlight mb20">숏컷 통계</h4>'; ?>
            <div class="box-table-header">
                ...
                <ul class="nav nav-pills">
                    <li role="presentation" class="active"><a href="<?php echo site_url($this->pagedir. '/lists/shortcut'); ?>">캠페인 목록</a></li>
                    <li role="presentation"><a href="<?php echo site_url($this->pagedir . '/real_click_list/shortcut'); ?>">실시간 리스트</a></li>
                    <li role="presentation"><a href="<?php echo site_url($this->pagedir . '/graph/shortcut'); ?>">기간별 그래프</a></li>
            ...
            <?php 
             ...
             ?>
            <div class="row">전체 : <?php echo element('total_rows', element('data', element('list', $view)), 0); ?>건</div>
                ...
                <table class="table table-hover table-striped table-bordered">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php 
                                if(element('pln_url',$result))
                                    foreach(element('pln_url',$result) as $key=> $value){
                                        echo '<div><i class="fa fa-link"></i><a href="'.element('pln_url',$value).'" target="_blank">'.cut_str(element('pln_url',$value),90).'</a></div>';
                                    }
                                 ?>
                            </td>
                            ...
                            <td><a href="<?php echo site_url($this->pagedir . '/real_click_list/shortcut');?>?post_id_[]=<?php echo element('post_id', $result)?>" class="btn btn-success btn-xs">통계보기</a></td>
                        </tr>
                    <?php
                        }
                    }
