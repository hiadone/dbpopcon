        ...
        <?php  echo '<h4 class="highlight mb20">미디어 통계</h4>'; ?>
            <div class="box-table-header">
                <ul class="nav nav-pills">
                    <li role="presentation" ><a href="<?php echo site_url($this->pagedir. '/lists/viashare'.'?'.$this->param->output()); ?>">캠페인 목록</a></li>
                    <li role="presentation" class="active"><a href="<?php echo site_url($this->pagedir . '/real_click_list/viashare?'.$this->param->output()); ?>">실시간 리스트</a></li>
                    <li role="presentation"><a href="<?php echo site_url($this->pagedir . '/graph/viashare?'.$this->param->output()); ?>">기간별 그래프</a></li>
                    <?php if (element('is_admin', $view)) { ?>
                    <li role="presentation"><a href="<?php echo site_url($this->pagedir . '/cleanlog/viashare'.'?'.$this->param->output()); ?>">로그삭제</a></li>
                    <?php } ?>
                </ul>
                <?php
                ob_start();
                ...
                <div class="pull-right mr10">
                    <ul class="nav nav-tabs clearfix">
                        <li role="presentation" <?php if ($this->uri->segment(2) === 'real_click_list') { ?>class="active" <?php } ?>><a href="<?php echo site_url($this->pagedir . '/real_click_list/viashare?'.$this->param->output()); ?>" >미디어 유입 통계</a></li>
                        <li role="presentation" <?php if ($this->uri->segment(2) === 'real_download_list') { ?>class="active" <?php } ?>><a href="<?php echo site_url($this->pagedir . '/real_download_list/viashare?'.$this->param->output()); ?>">상담신청 클릭 통계</a></li>
