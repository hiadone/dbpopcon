        ...
        <?php  echo '<h4 class="highlight mb20">미디어 통계</h4>'; ?>
            <div class="box-table-header">
                <ul class="nav nav-pills">
                    <li role="presentation" class="active"><a href="<?php echo site_url($this->pagedir. '/lists/nomal_campaign'.'?'.$this->param->output()); ?>">캠페인 목록</a></li>
                    <li role="presentation"><a href="<?php echo site_url($this->pagedir . '/real_click_list/nomal_campaign'.'?'.$this->param->output()); ?>">실시간 리스트</a></li>
                ...
                <table class="table table-hover table-striped table-bordered">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a href="<?php echo site_url($this->pagedir . '/real_click_list/nomal_campaign');?>?post_id_[]=<?php echo element('post_id', $result)?>" class="btn btn-success btn-xs">통계보기</a></td>
                        </tr>
                    <?php
                        }
                    }
