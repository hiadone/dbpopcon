        ...
        <input type="hidden" name="findex" value="<?php echo html_escape($this->input->get('findex')); ?>" />
            <div class="box-table-header">
                <ul class="nav nav-pills">
                    <li role="presentation" ><a href="<?php echo site_url($this->pagedir.'?'.$this->param->output()); ?>">캠페인 목록</a></li>
                    <li role="presentation" class="active"><a href="<?php echo site_url($this->pagedir . '/real_click_list?'.$this->param->output()); ?>">실시간 리스트</a></li>
                    <li role="presentation"><a href="<?php echo site_url($this->pagedir . '/graph?'.$this->param->output()); ?>">기간별 그래프</a></li>
                ...
                <div class="pull-right mr10">
                    <ul class="nav nav-tabs clearfix">
                        <li role="presentation" <?php if ($this->uri->segment($this->uri->total_segments()) === 'real_click_list') { ?>class="active" <?php } ?>><a href="<?php echo site_url($this->pagedir . '/real_click_list?'.$this->param->output()); ?>" >숏컷 클릭 통계</a></li>
                        <li role="presentation" <?php if ($this->uri->segment($this->uri->total_segments()) === 'real_download_list') { ?>class="active" <?php } ?>><a href="<?php echo site_url($this->pagedir . '/real_download_list?'.$this->param->output()); ?>">숏컷 설치 통계</a></li>
                ...
                <table class="table table-hover table-striped table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>그룹명</th>
                            <th>일시</th>
                            <?php if ($this->uri->segment($this->uri->total_segments()) === 'real_download_list') { ?><th>유입 URL</th> <?php } ?>
                            <th>IP</th>
                            <th>OS</th>
                    ...
                    ?>
                        <tr>
                            ...
                            <?php if ($this->uri->segment($this->uri->total_segments()) === 'real_download_list') { ?>
