...
<body>
    <div class="wrap">
        ...
        <div class="img_box"><img src="<?=$AD_DIR?>/images/energy_01.jpg" alt="국내판매율 1위 끼우는 비아X라 에너지링" class="img"></div>
        <div class="img_box"><img src="<?=$AD_DIR?>/images/energy_02.gif" alt="에너지링 ver.10minutes 관계전 10분 착용 당신의 섹스력은 높아집니다" class="img"></div>
        <div class="img_box"><img src="<?=$AD_DIR?>/images/energy_03.jpg" alt="에너지링 사용후기" class="img"></div>
        ...
        <div class="img_box"><img src="<?=$AD_DIR?>/images/energy_05.jpg" alt="에너지링의 혁신적인 기술력" class="img"></div>
        <div class="img_box"><img src="<?=$AD_DIR?>/images/energy_02_1.gif" alt="에너지링 ver.10minutes 관계전 10분 착용 당신의 섹스력은 높아집니다" class="img"></div>
        <div class="img_box"><img src="<?=$AD_DIR?>/images/energy_06.jpg" alt="에너지링 ver.10minutes 착용 후 10분뒤 성기의 변화" class="img"></div>
        <div class="img_box"><img src="<?=$AD_DIR?>/images/energy_04.jpg" alt="에너지링 14일 무료체험 이벤트 실시" class="img"></div>
                ...
                <div class="form_container">
                    <dl class="user_inp_container">
                        <div class="row clearfix">
                            ...
                            <dd class="inp_box">
                                <select name="mlh_mobileno1_" id="mlh_mobileno1_" class="inp inp_tel input02" label="연락처">
                                    <option <?php echo set_select('mlh_mobileno1_','010',true); ?>>010</option>
                                    <option <?php echo set_select('mlh_mobileno1_', '011'); ?> >011</option>
                                    <option <?php echo set_select('mlh_mobileno1_', '016'); ?>>016</option>
                                    <option <?php echo set_select('mlh_mobileno1_', '017'); ?>>017</option>
                                    <option <?php echo set_select('mlh_mobileno1_', '018'); ?>>018</option>
                                    <option <?php echo set_select('mlh_mobileno1_', '019'); ?>>019</option>
                                </select>
                                -
