...
<body>
    <div class="wrap">
        ...
        <div class="img_box"><img src="<?=$AD_DIR?>/images/du_01.jpg" alt="시술no! 리프팅? 이젠 집에서 하자! 4주후 피부 속탄력 94.4%상승 임상실험 입증" class="img"></div>
        <!-- btn -->
        <!-- <div class="title_box01">
            <a href="#formContainer" class="title_comment_link">
                <img src="<?=$AD_DIR?>/images/btn_gocomment.png" alt="comment 287" class="img">
            </a>
        </div> -->
        <!-- gif01 -->
        <div class="gif01">
        ...
        <div class="img_box"><img src="<?=$AD_DIR?>/images/du_04.png" alt="듀얼소닉 어떤효과가 있나요" class="img"></div>

        <!-- gif02 -->
        <div class="gif02">
            <div class="img_box"><img src="<?=$AD_DIR?>/images/du_05.gif" alt="듀얼소닉 원리 영상" class="img"></div>
        </div>
        
        <div class="img_box"><img src="<?=$AD_DIR?>/images/du_06.png" alt="듀얼소닉 원리" class="img"></div>

        <!-- gif03 -->
        <div class="gif03 clearfix">
            <div class="gif_gif_box img_box"><img src="<?=$AD_DIR?>/images/du_07.gif" alt="듀얼소닉 프로페셔널 강력한 접촉 초음파 젤튀는 영상" class="img"></div>
            <div class="gif_img_box img_box"><img src="<?=$AD_DIR?>/images/du_08.jpg" alt="고강도 집속 초음파란 (HIFU)" class="img"></div>
        </div>

        <div class="img_box"><img src="<?=$AD_DIR?>/images/du_09.png" alt="듀얼소닉 기사" class="img"></div>
        <div class="img_box"><img src="<?=$AD_DIR?>/images/du_10_2.jpg" alt="듀얼소닉 인체 시험결과" class="img"></div>
        <div class="img_box"><img src="<?=$AD_DIR?>/images/du_11_3.jpg" alt="듀얼소닉 가격" class="img"></div>
        <div class="img_box"><img src="<?=$AD_DIR?>/images/du_12.jpg" alt="듀얼소닉 실제사용자 후기" class="img"></div>
        ...
        <div class="gif01">
            <div class="img_box">
                <img src="<?=$AD_DIR?>/images/video03.gif" alt="듀얼소닉 사용예시영상" class="img">
            </div>
            <!-- <div class="video_box">
                <video class="video" preload="metadata" draggable="true" controls muted playsinline autoplay loop poster="<?=$AD_DIR?>/images/thum_video02.jpg">
                    <source src="<?=$AD_DIR?>/video/video02.mp4" type="video/mp4">
        ...
        <div class="img_box"><img src="<?=$AD_DIR?>/images/du_14.jpg" alt="듀얼소닉 수상 내역" class="img"></div>
        <!-- <div class="img_box"><img src="<?=$AD_DIR?>/images/event.gif" alt="쉿 오직 여기서만 100% 당첨 럭키박스" class="img"></div> -->
        <div id="formContainer" style="padding-top:40px;"></div>
        <!-- dbform -->
            ...
            <?php
                ...
                <table class="form_table">
                    <tbody>
                        ...
                        <tr>
                            <th class="lab_box">
                                <label for="mlh_text" class="lab">상담가능시간</label>
                            </th>
                            <td class="inp_box">
                ...
                <div class="btn_box txt_center">
                    <button class="btn_img"><img src="<?=$AD_DIR?>/images/btn_form.gif" alt="렌탈 가격 알아보기" class="img"></button>
                    <!-- <img src="<?=$AD_DIR?>/images/btn_tag.png" alt="결제 no, 상담만" class="tag_btnimg"> -->
                </div>
                <div class="agree_check agree_box txt_center">
                    <input type="checkbox" name="agree" id="agree" class="inp_agree" checked> 
                    <label for="agree" class="lab_agree">개인정보 수집 정책에 동의 합니다</label>
                    | <button class="btn_popup" type="button" onclick="openPopup('popupAgree')">약관보기</button>
                </div>
                <div class="txt_center txt_notice" >
                    <p class="txt_notice01">
                        안심하세요! 고객님!
                    </p>
                    <p class="txt_notice02">
                ...
                <div class="comment_box">
                    <div class="comment_head clearfix">
                        ...
                        <div class="comment_info">
                            ...
                            <div class="comment_date">2020.10.02  14:43</div>
                        </div>
                    </div>
                ...
                <div class="comment_box">
                    <div class="comment_head clearfix">
                        ...
                        <div class="comment_info">
                            ...
                            <div class="comment_date">2020.10.03  22:56</div>
                        </div>
                    </div>
                    <div class="comment_body">
                        <div class="comment_text">
                ...
                <div class="comment_box">
                    <div class="comment_head clearfix">
                        ...
                        <div class="comment_info">
                            ...
                            <div class="comment_date">2020.10.05  09:12 </div>
                        </div>
                    </div>
                    <div class="comment_body">
                        <div class="comment_text">
                ...
                <div class="comment_box">
                    <div class="comment_head clearfix">
                        ...
                        <div class="comment_info">
                            ...
                            <div class="comment_date">2020.10.06  10:25 </div>
                        </div>
                    </div>
                    <div class="comment_body">
                        <div class="comment_text">
                ...
                <div class="comment_box">
                    <div class="comment_head clearfix">
                        ...
                        <div class="comment_info">
                            ...
                            <div class="comment_date">2020.10.08  11:52 </div>
                        </div>
                    </div>
                    <div class="comment_body">
                        <div class="comment_text">
                ...
                <div class="comment_box">
                    <div class="comment_head clearfix">
                        ...
                        <div class="comment_info">
                            ...
                            <div class="comment_date">2020.10.10  17:11 </div>
                        </div>
                    </div>
                    <div class="comment_body">
                        <div class="comment_text">
                ...
                <div class="comment_box">
                    <div class="comment_head clearfix">
                        ...
                        <div class="comment_info">
                            ...
                            <div class="comment_date">2020.10.11  22:59 </div>
                        </div>
                    </div>
                    <div class="comment_body">
                        <div class="comment_text">
