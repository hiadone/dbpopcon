	...
	<div class="container" style="padding:0px">
			...
			<div class="inbox">
				<table>
					...
					<tbody>
						...
						<tr>
							<th>나이</th>
							<td><input type="number" class="form-class input" id="mlh_age" name="mlh_age"  label="나이" style="width:80px; float:left;"> <label style="position:relative;float:left; top:6px; left:3px;">세</label></td>
						</tr>
						<tr>
							<th>연락처</th>
				...
				<p><a name="mem_linkmine" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_mem_linkmine"><input type="image" img src="<?=$AD_DIR?>/images/btn.png" style="width:90%" ></a></p>
				<?php echo form_close(); ?>

				<p style="text-align:center;padding:10px;">기입하신 수집된 정보는 본 이벤트 이외에<br>어떤용도로도 사용되지 않습니다!</p>
			</div>
		</section>
		...
		<section class="inDB">
			...
			<div class="inbox">
				...
				<p class="t-center" style="padding-top:15px;"><a name="mem_linkmine" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_mem_linkmine"><input type="image" img src="<?=$AD_DIR?>/images/btn.png" style="width:90%" ></a></p>
				<?php echo form_close(); ?>
				<p style="text-align:center;padding:10px;">기입하신 수집된 정보는 본 이벤트 이외에<br>어떤용도로도 사용되지 않습니다!</p>
			</div>
		</section>
        <section><img src="<?=$AD_DIR?>/images/4441.jpg"></section>

		<footer>
			<p>
				사업자 등록번호 : 185-03-00961<br>
				대표자 : 박태민<br>
				상호 : <strong>다올헬시</strong><br>
				소재지 : 경기도 고양식 일산동구 호수로 672, 1512호<br>(장항동, 대우메종리브르)
			</p>
		</footer>
