...
<!-- ONNURIDMC CTS  START V.1.0 -->
<script type="text/javascript">
(function(w, d, n, s, e, o){
 if(!w[n]){
    w[n] = function(){(w[n].q = w[n].q || []).push(arguments);if(typeof(__alinklog) != 'undefined') __alinklog();};
    e = d.createElement(s);e.async = 1;e.charset = 'utf-8';
    e.src='//api.a-link.co.kr/js/st/shop_1.0.js';
    o = d.getElementsByTagName(s)[0];o.parentNode.insertBefore(e, o);
  }
})(window, document, 'AlinkLog', 'script');
AlinkLog('IN07147', 'log');
</script>
<!-- END OF ONNURIDMC CTS -->
				...
				<table class="consult1 width90">
					...
					<tbody class="con_m">
						...
						<tr>
							...
							<td><textarea class="width95 input" id="mlh_text" name="mlh_text" class="width95" label="문의사항"></textarea></td>
						</tr>
						<tr>
...
<?php if($this->session->flashdata('mlh_id')){?>
    ...
    _link_postBack("<?php echo $this->session->flashdata('mlh_name') ?>", "<?php echo $this->session->flashdata('mlh_age') ?>", "<?php echo $this->session->flashdata('mlh_mobileno') ?>");
