...
<script type='text/javascript'>
  ...
  window._tfa.push({notify: 'event', name: 'page_view', id: 1117703});
  !function (t, f, a, x) {
  ...
  '//cdn.taboola.com/libtrc/unip/1117703/tfa.js',
  'tb_tfa_script');
</script>
<noscript>
  <img src='https://trc.taboola.com/1117703/log/3/unip?en=page_view'
...
<!-- End of Taboola Pixel Code -->
    ...
    <?php if($this->session->flashdata('mlh_id')){ ?>
            ...
            <!-- Taboola Pixel Code -->
<script>
    _tfa.push({notify: 'event', name: 'lead', id: 1117703});
</script>
<noscript>
    <img src='https://trc.taboola.com/1117703/log/3/unip?en=lead'
        width='0' height='0' style='display:none'/>
</noscript>
<!-- End of Taboola Pixel Code -->
