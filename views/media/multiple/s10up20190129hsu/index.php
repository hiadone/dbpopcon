...
<body>
	<div class="container" style="padding:0px;">
		...
		<!-- <section><a href="tel:070-7606-5417"><img src="<?=$AD_DIR?>/images/tel.jpg"></a></section> -->
		<section><img src="<?=$AD_DIR?>/images/c03.jpg?v=1"></section>
		<section><img src="<?=$AD_DIR?>/images/c03_ani.gif"></section>
        <section class="inDB">
        	<?php
			...
			<div class="inbox">
				...
				<a name="mem_linkmine" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_mem_linkmine"><input type="image" img src="<?=$AD_DIR?>/images/btn.gif"  style="border: 0px;width:100%"></a>
		...
		<section class="inDB">
			...
			<div class="inbox">
				...
				<p class="t-center" style="padding-top:15px;"><a name="mem_linkmine" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_mem_linkmine"><input type="image" img src="<?=$AD_DIR?>/images/btn.gif"  style="border: 0px;width:100%"></a></p>
