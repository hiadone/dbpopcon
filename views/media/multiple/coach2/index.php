...
$this->managelayout->add_meta('<meta name="viewport" content="width=800, user-scalable=yes">'); 
...
?>  
    ...
    <?php if(strtolower(element('multi_code',$view))==='c02050' || strtolower(element('multi_code',$view))==='c090'){ ?>
    ...
    <?php if(strtolower(element('multi_code',$view))==='c040'){ ?>
        ...
        <script  src ="//cdnet.nasmob.com/adpacker/js/ap_pv_v2.0.js"></script>
        <?php if($this->session->flashdata('mlh_id')){ ?>
    ...
    <?php if(strtolower(element('multi_code',$view))==='c050' || strtolower(element('multi_code',$view))==='c050_m'){ ?>
        ...
        <?php if($this->session->flashdata('mlh_id')){ ?>
            ...
            <!-- Event snippet for 상담신청_일반형 conversion page -->
            <script>
              gtag('event', 'conversion', {'send_to': 'AW-613453579/KpWrCMeKmNkBEIuewqQC'});
            </script>
        ...
        <?php } else{ ?>
            ...
            function gtag_report_conversion(url) {
              ...
              gtag('event', 'conversion', {
                  'send_to': 'AW-613453579/KpWrCMeKmNkBEIuewqQC',
    ...
    <div class="wrap">
        ...
        <div class="form_container01">
            <?php 
                ...
                <div class="btn_box">
                    <button class="btn_img" type="button" onclick='submitContents(this)'>
        ...
        <div class="form_container02" id="formContainer">
            <?php 
                $attributes = array('class' => 'form-horizontal', 'name' => 'fwrite', 'id' => 'fwrite_');
                echo form_open(current_full_url(), $attributes);
                ?>
                <input type="hidden" name="post_id" id="post_id" value="<?php echo element('post_id',element('post', $view));?>">
                <input type="hidden" name="redirecturl" value="<?php  echo current_full_url()?>">
                ...
                <input type="hidden" name="cfc_num_" value="0" id="cfc_num__">      
                ...
                <div class="inp_wrap">
                    ...
                    <div class="btn_box txt_center">
                        <button class="btn_img" type="button" onclick='submitContents02(this)'>
        ...
        <div class="popup_wrap" id="popupWrap">
            ...
            <div class="popup_sms" id="popupSMS_">
                <div class="sms_content">
                    <div class="sms_title">
                        <b>문자(SMS)</b>로 발송된 인증번호를 입력하세요.
                    </div>
                    <div class="sms_box clearfix">
                        <input type="number" name="cfc_num1" id="cfc_num1" placeholder="인증번호" class="inp_sms">
                        <button type="button" onclick="smsmap_()" class="btn_sms">확인</button>
                    </div>
                </div>
            </div>
            <!-- 개인정보취급방침 팝업 -->
        ...
        function submitContents(f) {
            ...
            if($('input[id="agree01"]').is(":checked") && $('input[id="agree02"]').is(":checked")){
                ...
                $.ajax({
                    ...
                    data: {
                        post_id: $('#post_id').val(),
                        mlh_mobileno: $("#mlh_mobileno1").val()+$("#mlh_mobileno2").val()+$("#mlh_mobileno3").val(),
        ...
        function submitContents02(f) {
            ...
            if($('input[id="agree01_"]').is(":checked") && $('input[id="agree02_"]').is(":checked")){
                ...
                $.ajax({
                    ...
                    data: {
                        post_id: $('#post_id').val(),
                        mlh_mobileno: $("#mlh_mobileno1_").val()+$("#mlh_mobileno2_").val()+$("#mlh_mobileno3_").val(),
                        mlh_name: $('#mlh_name_').val(),
                        multi_code: $('#multi_code').val(),
                        post_title: "<?php echo element('post_title',element('post', $view));?>",                        
                        csrf_test_name: cb_csrf_hash,
                    },      
        ...
        function smsmap_() {
            ...
            if(!$('#cfc_num1').val()) {
                ...
                $.ajax({
                    ...
                    data: {
                        post_id: $('#post_id').val(),
                        mlh_mobileno: $("#mlh_mobileno_").val(),
                        mlh_name: $('#mlh_name_').val(),
                        multi_code: $('#multi_code').val(),
                        cfc_num: $('#cfc_num1').val(),                        
                        csrf_test_name: cb_csrf_hash,
                    },      
                    dataType : 'json',
                    success : function(data) {
