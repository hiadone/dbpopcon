...
<body>
    <div class="wrap">
        ...
        <div class="img_box"><img src="<?=$AD_DIR?>/images/e_img01.jpg" alt="남성성기능장애 집중조명 energy ring" class="img"></div>
        <div class="img_box"><img src="<?=$AD_DIR?>/images/e_img02.jpg" alt="발기부전, 조루증 한방에 해결가능" class="img"></div>
        <div class="img_box"><img src="<?=$AD_DIR?>/images/e_img03.jpg" alt="성기능 개선 No.1 2018 최고의 히트상품" class="img"></div>
        <div class="img_box"><img src="<?=$AD_DIR?>/images/e_img04.jpg" alt="에너지링 Ver.10minutes는 이런 남성들이 착용해야 합니다" class="img"></div>
        <div class="img_box"><img src="<?=$AD_DIR?>/images/e_img05.gif" alt="에너지링의 4 Power Up 프로젝트" class="img"></div>
        <div class="img_box"><img src="<?=$AD_DIR?>/images/e_img06.jpg" alt="에너지링 구성" class="img"></div>
        <div class="img_box"><img src="<?=$AD_DIR?>/images/e_img07.jpg" alt="에너지링 후기" class="img"></div>
        <div class="img_box"><img src="<?=$AD_DIR?>/images/p_img08.jpg" alt="에너지링 만족도 그래프" class="img"></div>
        <div class="img_box"><img src="<?=$AD_DIR?>/images/p_img09.jpg" alt="자신감 업하고 싶은 사람에게 필요한 마법같은 변화" class="img"></div>
        <div class="img_box"><img src="<?=$AD_DIR?>/images/p_img10.jpg" alt="에너지링 14일 모료체험 이벤트 실시" class="img"></div>
    ...
    <!-- http://admins.co.kr/event/energyring1/m03/ -->
</body>
</html>