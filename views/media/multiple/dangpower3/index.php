...
?>  
    ...
    <script type='text/javascript'>
      ...
      window._tfa.push({notify: 'event', name: 'page_view', id: 1134333});
      !function (t, f, a, x) {
      ...
      '//cdn.taboola.com/libtrc/unip/1134333/tfa.js',
      'tb_tfa_script');
    </script>
    <noscript>
      <img src='https://trc.taboola.com/1134333/log/3/unip?en=page_view'
    ...
    <?php if($this->session->flashdata('mlh_id')){ ?>
            ...
            <!-- Taboola Pixel Code -->
            <script>
                _tfa.push({notify: 'event', name: 'lead', id: 1134333});
            </script>
            <noscript>
                <img src='https://trc.taboola.com/1134333/log/3/unip?en=lead'
                    width='0' height='0' style='display:none'/>
            </noscript>
            <!-- End of Taboola Pixel Code -->
...
<body>
    <div class="wrap">
        ...
        <div class="img_box"><img src="<?=$AD_DIR?>/images/n_dang2.png?u=2" alt="높은 혈압의 감소 식약처 기능성 인정" class="img"></div>
