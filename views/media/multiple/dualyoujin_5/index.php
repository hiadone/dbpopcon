...
$this->managelayout->add_css("//cdn.jsdelivr.net/gh/moonspam/NanumSquare@1.0/nanumsquare.css"); 
...
<!--             <a href="#formContainer" class="btn_img btn_goform"><img src="<?=$AD_DIR?>/images/btn_goform.png" class="img" alt="자세하게 알아보기"></a>
        ...
        <div class="img_box"><img src="<?=$AD_DIR?>/images/u8.jpg?u=<?php echo date('Ymd') ?>" alt="수시로 가던 피부과, 이제 절대 안가요!" class="img"></div>        
