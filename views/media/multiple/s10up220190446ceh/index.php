...
<body>
	<div class="container" style="max-width:730px;padding:0px;">
		...
		<section><img src="<?=$AD_DIR?>/images/1.png"></section>
		<section><img src="<?=$AD_DIR?>/images/2.png"></section>
		<section><img src="<?=$AD_DIR?>/images/3.png"></section>
		...
		<section><img src="<?=$AD_DIR?>/images/a_1.png"></section>
		<section><img src="<?=$AD_DIR?>/images/5.png"></section>
		<section><img src="<?=$AD_DIR?>/images/6.png"></section>
		<section><img src="<?=$AD_DIR?>/images/7_.png"></section>
			...
			<div class="inbox">
				...
				<table>
					...
					<tbody>
						...
						<tr>
							<th>나이</th>
							<td><input type="number" class="form-class input2" name="mlh_age" id="mlh_age2" label="나이" style="width:80px; float:left;"> <label style="position:relative;float:left; top:6px; left:3px;">세</label></td>
						</tr>
						<tr>
							<th>연락처</th>
							<td><input type="tel" class="form-class input2 " name="mlh_mobileno" id="mlh_mobileno2" label="연락처"></td>
						</tr>
						<tr>
							<th>문의사항</th>
							<td>
				...
				<p class="t-center" style="padding-top:15px;"><a name="mem_tenping" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_tenping"><input type="image"  class="btn" style="max-width: 100%;" src="<?=$AD_DIR?>/images/btn1.jpg" ></a></p>
				<?php echo form_close(); ?>
			</div>
		</section>
