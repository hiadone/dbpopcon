...
.alert 
{
  ...
  <script type="text/javascript">
	...
	<script>
		...
		fbq('init', '1558355774287846');
		fbq('track', 'PageView');
	</script>
	<noscript><img height="1" width="1" style="display:none;" src="https://www.facebook.com/tr?id=1558355774287846&ev=PageView&noscript=1"/></noscript>
...
<body>
	<div class="container">
		...
		<section><img src="<?=$AD_DIR?>/images/a01.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/a02.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/a03.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/a04.jpg"></section>
		<section><a href="tel:1644-0591"><img src="<?=$AD_DIR?>/images/tel.jpg"></a></section>
		...
		<section class="inDB">
			...
			<div class="inbox">
				<p class="t-center"><img src="<?=$AD_DIR?>/images/db_top.jpg"></p>
				<table>
					<colgroup>
						<col width="">
						<col width="">
					...
					<tbody>
						...
						<tr>
							<td colspan="2">
								...
								<a name="mem_tenping" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_tenping"><input type="image" img src="<?=$AD_DIR?>/images/a07.png" style="width:100%"></a>
							</td>
						</tr>
					</tbody>
				</table>
