	...
	<div class="container" style="padding:0px">
		...
		<section class="inDB">
			...
			<div class="inbox">
				...
				<a name="mem_tenping" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_tenping"><input type="image" img src="<?=$AD_DIR?>/images/btn2.jpg" style="max-width: 80%;"></a></p>
				<?php echo form_close(); ?>
			</div>
		</section>
