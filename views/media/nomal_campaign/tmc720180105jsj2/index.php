	...
	<input type="hidden" name="jid" value="<?php echo $jid?>">        
			<table>
				...
				<tr>
					...
					<tr>
						<th>문의사항</th>
						<td><textarea  rows="4" class="form-class input" rows="5" id="mlh_text" name="mlh_text" label="문의사항"></textarea></td>
					</tr>
					<tr>
						<td colspan="2">
							<p class="a-center"><input type="checkbox" id="agree" checked> <label for="agree"><span>개인정보 수집 및 이용동의</span></label></p>
						</td>
					</tr>
				</tbody>
			</table>
		...
		<?php
			...
			<table>
				...
				<tr>
					...
					<tr>
						<td colspan="2">
							<p class="a-center"><input type="checkbox" id="agree2" checked> <label for="agree2"><span>개인정보 수집 및 이용동의</span></label></p>
						</td>
					</tr>
				</tbody>
			</table>
	...
	<section class="inDB">     
			<table>
				...
				<tr>
					...
					<tr>
						<th>나이</th>
						<td><input type="text" class="form-class input3" name="mlh_age" id="mlh_age" label="나이" style="display:inline-block;width:35%;">
							<span>세</span>
						</td>
					</tr>
					<tr>
						<th>연락처</th>
						<td><input type="tel" class="form-class input3" name="mlh_mobileno" id="mlh_mobileno" label="휴대전화"></td>
					</tr>
					<tr>
						<th>문의사항</th>
						<td><textarea  class="form-class input3" rows="5" id="mlh_text" name="mlh_text" label="문의사항"></textarea></td>
					</tr>
					<tr>
						<td colspan="2">
							<p class="a-center"><input type="checkbox" id="agree3" checked> <label for="agree3"><span>개인정보 수집 및 이용동의</span></label></p>
						</td>
					</tr>
				</tbody>
			</table>
