...
<footer onclick="fnMove();">
	<img src="<?=$AD_DIR?>/images/scroll.png">
</footer>
...
<div id="wrap">
	<div class="container" style="width: 100%">
		...
		<section id="inDB2">
	      ...
	      <table>
					...
					<tr>
						...
						<tr>
							<td colspan="2">
								<p class="a-center"><input type="checkbox" id="agree" checked> <label for="agree"><span style="color:#000;">개인정보 수집 및 이용동의</span></label></p>
							</td>
						</tr>
					</tbody>
				</table>
				<p class="a-center"><a name="mem_linkmine" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_mem_linkmine"><input type="image" img src="<?=$AD_DIR?>/images/db_btn.jpg" style="max-width: 80%;"></a></p>
	      		<?php echo form_close(); ?>
	      <br>
		</section>
		...
		<section id="inDB">
			<div class="inBox">	
				<p class="inheader"><img src="<?=$AD_DIR?>/images/db_top.jpg"></p>
				<?php
	      ...
	      <table>
					...
					<tr>
							<th>성함</th>
							<td><input type="text" id="mlh_name" name="mlh_name" class="form-class input2" label="성함"></td>
						</tr>
						<tr>
							<th>나이</th>
							<td><input type="text" id="mlh_age" name="mlh_age" class="form-class input2" label="나이" style="display:inline-block;width:35%;">
								<span style="color:#000">세</span>
							</td>
						</tr>
						<tr>
							<th>연락처</th>
							<td><input type="tel" id="mlh_mobileno" name="mlh_mobileno" class="form-class input2" label="연락처"></td>
						</tr>
						<tr>
							<th>문의사항</th>
							<td><textarea id="mlh_text" name="mlh_text" rows="4" class="form-class input2" label="문의사항"></textarea></td>
						</tr>
						<tr>
							<td colspan="2">
								<p class="a-center"><input type="checkbox" id="agree2" checked> <label for="agree2"><span style="color:#000;">개인정보 수집 및 이용동의</span></label></p>
							</td>
						</tr>
					</tbody>
				</table>
...
<style>
	...
	.label p { display:inline-block; background-color:#df0000; color:#FFF; font-size:14px; font-weight:bold; padding:5px 10px; border-radius:4px;
		...
		background: linear-gradient(top bottom,  #dd2c2c 0%,#db4141 49%,#df0000 52%,#ff5f47 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
