...
<body>
	<div class="container">
		...
		<section><img src="<?=$AD_DIR?>/images/3_1.jpg"></section>
		...
		<section id="inDB">
			...
			<table>
				...
				<tbody>
					...
					<tr>
						<td colspan="2">
							<a name="mem_tenping" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_tenping"><input type="image" img src="<?=$AD_DIR?>/images/btn1.gif" style="max-width: 100%;"></a>
						</td>
					</tr>
					<?php echo form_close(); ?>
				</tbody>
		...
		<section><img src="<?=$AD_DIR?>/images/3_2.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/4.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/5.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/5_2.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/6.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/6_2.jpg"></section>
		<section id="inDB2">
			<?php
            ...
            <input type="hidden" name="redirecturl" value="<?php  echo current_full_url()?>">
            <input type="hidden" name="jid" value="<?php echo $jid?>">  			
			<p><img src="<?=$AD_DIR?>/images/db_img.jpg"></p>
			<table>
				<colgroup>
					<col width="">
					<col width="">
