...
<body>
    ...
    <div class="db_click"><a href="javascript:fnMove();"><img src="<?=$AD_DIR?>/images/scroll.png" class="img100"></a></div>
        ...
        <section class="inDB">
			...
			<p><img src="<?=$AD_DIR?>/images/db_top1.jpg"></p>
			<table>
				<colgroup>
					<col width="">
					<col width="">
          ...
          <tr>
            <th>나이</th>
            <td><input type="number" class="form-class input" name="mlh_age" id="mlh_age" label="나이" style="width:100px; float:left;"> <label style="position:relative;float:left; top:10px; left:10px;">세</label></td>
          </tr>
					<tr>
						<th>연락처</th>
			...
			<a name="mem_tenping" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_tenping"><input type="image" img src="<?=$AD_DIR?>/images/db_btn.jpg" style="max-width: 100%;"></a>
			<?php echo form_close(); ?>
		</section>
		...
		<section class="inDB">
            ...
            <input type="hidden" name="redirecturl" value="<?php  echo current_full_url()?>">
            <input type="hidden" name="jid" value="<?php echo $jid?>">  
			     <p id="db2"><img src="<?=$AD_DIR?>/images/db_top1.jpg"></p>
			<table>
				<colgroup>
					<col width="">
					<col width="">
          ...
          <tr>
            <th>나이</th>
            <td><input type="number" class="form-class input2" name="mlh_age" id="mlh_age" label="나이" style="width:100px; float:left;"> <label style="position:relative;float:left; top:10px; left:10px;">세</label></td>
          </tr>
					<tr>
						<th>연락처</th>
