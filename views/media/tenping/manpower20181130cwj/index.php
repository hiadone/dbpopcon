	...
	<div class="container">
        ...
        <section class="inDB">
            ...
            <input type="hidden" name="jid" value="<?php echo $jid?>">  
				...
				<a name="mem_tenping" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_tenping"><input type="image" img src="<?=$AD_DIR?>/images/btn2.jpg" style="max-width: 100%;"></a><br>
