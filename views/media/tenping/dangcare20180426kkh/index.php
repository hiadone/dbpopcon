...
<body>
	<div class="container">
		...
		<section id="inDB" class="inDB">
			...
			<p class="t-center" style="padding:20px 0;"><a name="mem_tenping" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_tenping"><input type="image" img src="<?=$AD_DIR?>/images/btn_001.png" style="max-width: 100%;"></a></p>
			<?php echo form_close(); ?>
		</section>
		...
		<section><a href="tel:070-4327-8033"><img src="<?=$AD_DIR?>/images/footer.jpg"></a></section>
