        ...
        <section class="inDB">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <th>연락처</th>
                        <td><input type="tel" class="form-class input" id="mlh_mobileno" name="mlh_mobileno"  label="휴대전화"></td>
                    </tr>
                    <tr>
                        <th>문의사항</th>
                        <td>
                    ...
                    <tr>
                        <td colspan="2" class="t-center" style="padding:10px 0;">
                            <a name="mem_tenping" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_tenping"><input type="image" img src="<?=$AD_DIR?>/images/btn.jpg" style="max-width: 100%;"></a></a>
                        </td>
                    </tr>
                </tbody>
            </table>
