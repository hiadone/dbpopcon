			...
			<table>
				...
				<tbody>
					...
					<tr>
						<th>남기고<br>싶은말</th>
						<td>
							<textarea class="form-class input" rows="5" id="mlh_text" name="mlh_text" label="남기고싶은말"></textarea>
						</td>
					</tr>
					<tr>
		...
		<section id="inDB">
			...
			<table>
				...
				<tbody>
					<tr>
						<th>성 함</th>
						<td><input type="text" class="form-class  input2" id="mlh_name2" name="mlh_name" label="성함"></td>
					</tr>
					<tr>
						<th>나 이</th>
					...
					<tr>
						<th>남기고<br>싶은말</th>
						<td>
							<textarea class="form-class input2" rows="5" id="mlh_text2" name="mlh_text" label="남기고싶은말"></textarea>
						</td>
					</tr>
					<tr>
						<td colspan="2" class="t-center">
					...
					<tr>
						<td colspan="2" class="t-center" style="padding:0;">
							<a name="mem_tenping" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_tenping2"><input type="image" img src="<?=$AD_DIR?>/images/btn.jpg" style="max-width: 100%;"></a>
						</td>
					</tr>
				</tbody>
			</table>
