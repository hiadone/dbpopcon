...
<body>
	<div class="container">
		...
		<section id="inDB">
			...
			<table>
				...
				<tbody>
					...
					<tr>
						<th>나이</th>
						<td><input type="number" class="form-class input" name="mlh_age" id="mlh_age" label="나이" style="width:40%; float:left;"> <label style="position:relative;float:left; top:10px; left:10px;">세</label></td>
					</tr>
					<tr>
						<th>연락처</th>
					...
					<tr>
						<th>문의사항</th>
						<td>
							<textarea class="form-class input" rows="5" id="mlh_text" name="mlh_text" label="문의사항"></textarea></td>
						</td>
					</tr>
					<tr>
		...
		<section id="inDB2">
			<p><img src="<?=$AD_DIR?>/images/db_top2.jpg"></p>
			<?php
		...
		<br><br>
		<section><a href="tel:070-7436-0513"><img src="<?=$AD_DIR?>/images/footer.jpg"></a></section>
