            ...
            <div class="inp_box">
                <dl class="inp_list">
                    ...
                    <dd class="inp inp_name">
                        <input type="text" class="input" id="mlh_name" name="mlh_name" label="이름" value="<?php echo set_value('mlh_name', element('mlh_name', element('post', $view))); ?>">
                    </dd>
                    <dt class="lab"><label for="">나이</label></dt>
                    <dd class="inp inp_age">
                        <input type="number" class=" input" name="mlh_age" id="mlh_age" label="나이" value="<?php echo set_value('mlh_age', element('mlh_age', element('post', $view))); ?>">
                    </dd>
                    <dt class="lab"><label for="">연락처</label></dt>
                    <dd class="inp inp_tel">
                        <input type="tel" class="input" style="width:25%;" id="mlh_mobileno1" name="mlh_mobileno1" label="연락처" maxlength="3" value="<?php echo set_value('mlh_mobileno1', element('mlh_mobileno1', element('post', $view))); ?>"> -
                        <input type="tel" class="input" style="width:25%;" id="mlh_mobileno2" name="mlh_mobileno2" label="연락처" maxlength="4" value="<?php echo set_value('mlh_mobileno2', element('mlh_mobileno2', element('post', $view))); ?>"> -
                        <input type="tel" class="input" style="width:25%;" id="mlh_mobileno3" name="mlh_mobileno3" label="연락처" maxlength="4" value="<?php echo set_value('mlh_mobileno3', element('mlh_mobileno3', element('post', $view))); ?>">
                    </dd>
                    <dt class="lab"><label for="">상담내용</label></dt>
                    <dd class="inp inp_txt">
                        <textarea class="input" rows="4" id="mlh_text" name="mlh_text" label="상담내용"><?php echo set_value('mlh_text', element('mlh_text', element('post', $view))); ?></textarea>
                    </dd>
                </dl>
        ...
        <?php
            ...
            <div class="inp_box">
                ...
                <dl class="inp_list">
                    <dt class="lab"><label for="">이름</label></dt>
                    <dd class="inp inp_name">
                        <input type="text" class="input2" id="mlh_name" name="mlh_name" label="이름" value="<?php echo set_value('mlh_name', element('mlh_name', element('post', $view))); ?>">
                    </dd>
                    <dt class="lab"><label for="">나이</label></dt>
                    <dd class="inp inp_age">
                        <input type="number" class=" input2" name="mlh_age" id="mlh_age" label="나이" value="<?php echo set_value('mlh_age', element('mlh_age', element('post', $view))); ?>">
                    </dd>
                    <dt class="lab"><label for="">연락처</label></dt>
                    <dd class="inp inp_tel">
                        <input type="tel" class="input2" style="width:25%;" id="mlh_mobileno_1" name="mlh_mobileno1" label="연락처" maxlength="3" value="<?php echo set_value('mlh_mobileno1', element('mlh_mobileno1', element('post', $view))); ?>"> -
                        <input type="tel" class="input2" style="width:25%;" id="mlh_mobileno_2" name="mlh_mobileno2" label="연락처" maxlength="4" value="<?php echo set_value('mlh_mobileno2', element('mlh_mobileno2', element('post', $view))); ?>"> -
                        <input type="tel" class="input2" style="width:25%;" id="mlh_mobileno_3" name="mlh_mobileno3" label="연락처" maxlength="4" value="<?php echo set_value('mlh_mobileno3', element('mlh_mobileno3', element('post', $view))); ?>">
                    </dd>
                    <dt class="lab"><label for="">상담내용</label></dt>
                    <dd class="inp inp_txt">
                        <textarea class="input2" rows="4" id="mlh_text" name="mlh_text" label="상담내용"><?php echo set_value('mlh_text', element('mlh_text', element('post', $view))); ?></textarea>
                    </dd>
                </dl>
                   <div class="" style="color:red;font-family: bold;font-size:20px;text-align:center;">
                   <?php 
