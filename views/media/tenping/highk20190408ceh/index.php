...
<body>
	<div class="container" style="padding:0px">
		...
		<section><img src="<?=$AD_DIR?>/images/hiki-01.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/hiki-02.gif"></section>
		<section><img src="<?=$AD_DIR?>/images/hiki-03_.jpg"></section>
        <section class="inDB">
        	<?php
			...
			<div class="inbox">
				...
				<p><a name="mem_linkmine" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_mem_linkmine"><input type="image" img src="<?=$AD_DIR?>/images/button.jpg" style="width:90%" ></a></p>

				<p style="text-align:center; padding:10px;">기입하신 수집된 정보는 본 이벤트 이외에 어떤용도로도 사용되지 않습니다!</p>
				<?php echo form_close(); ?>
			</div>
		</section>
		<section><img src="<?=$AD_DIR?>/images/hiki-04.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/hiki-05.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/hiki-06.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/hiki-07.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/hiki-08.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/hiki-09.gif"></section>
		<section><img src="<?=$AD_DIR?>/images/hiki-10_.jpg"></section>
		<section class="inDB">
			<?php
			...
			<div class="inbox">
				<table>
					...
					<tbody>
						...
						<tr>
							<th>나이</th>
							<td><input type="number" class="form-class input2" id="mlh_age" name="mlh_age"  label="나이" style="width:80px; float:left;"> <label style="position:relative;float:left; top:6px; left:3px;">세</label></td>
						</tr>
						<tr>
							<th>연락처</th>
				...
				<p class="t-center" style="padding-top:15px;"><a name="mem_linkmine" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_mem_linkmine"><input type="image" img src="<?=$AD_DIR?>/images/button.jpg" style="width:90%" ></a></p>
				<p style="text-align:center; padding:10px;">기입하신 수집된 정보는 본 이벤트 이외에 어떤용도로도 사용되지 않습니다!</p>
				<?php echo form_close(); ?>
			</div>
		</section>
		<section><img src="<?=$AD_DIR?>/images/bm.jpg"></section>
