...
<body>
	<div class="container" >
		...
		<section><img src="<?=$AD_DIR?>/images/top.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/top_2.gif"></section>
		<section><img src="<?=$AD_DIR?>/images/img_18.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/gif.gif"></section>
		<section><img src="<?=$AD_DIR?>/images/img_19.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/img_20.jpg"></section>
		...
		<section id="inDB">
			...
			<a name="mem_tenping" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_tenping"><input type="image" img src="<?=$AD_DIR?>/images/btn01.gif" style="max-width: 100%;"></a>
			<?php echo form_close(); ?>
			
		</section>
		<section><img src="<?=$AD_DIR?>/images/cont_img0202.jpg?ver=1.0"></section>
		<section><img src="<?=$AD_DIR?>/images/img_22.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/img_25.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/ani_04_black.gif"></section>
		<section><img src="<?=$AD_DIR?>/images/img_24.jpg?ver=1.0"></section>
		<section><img src="<?=$AD_DIR?>/images/cont_img0202.jpg?ver=1.0"></section>
		<section><img src="<?=$AD_DIR?>/images/img_11.jpg"></section>
		<section id="inDB">
			<?php
		...
		<section><img src="<?=$AD_DIR?>/images/footer.gif"></section>
	</div>
