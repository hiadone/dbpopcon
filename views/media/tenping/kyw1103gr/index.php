...
<body>
	<div class="container">
		...
		<section><img src="<?=$AD_DIR?>/images/8.jpg?ver=0.2"></section>
		<section><img src="<?=$AD_DIR?>/images/cla11_ani_01.gif"></section>
		<section><img src="<?=$AD_DIR?>/images/2.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/img_17.jpg"></section>
		...
		<section id="inDB">
			...
			<img src="<?=$AD_DIR?>/images/img_11.jpg">
			<table>
				<colgroup>
					<col width="">
					<col width="">
				...
				<tbody>
					...
					<tr>
						<td colspan="2" class="t-center">
							<a name="mem_tenping" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_tenping"><input type="image" img src="<?=$AD_DIR?>/images/btn1.png" style="max-width: 70%;"></a>
						</td>
					</tr>
				</tbody>
			</table>
		...
		<section><img src="<?=$AD_DIR?>/images/5.jpg?ver=0.2"></section>
		<section><img src="<?=$AD_DIR?>/images/6.jpg?ver=0.2"></section>
		<section><img src="<?=$AD_DIR?>/images/img_16.jpg?ver=0.2"></section>
		...
		<section id="inDB2">
			...
			<table>
				...
				<tbody>
					<tr>
						<th>이름</th>
						<td><input type="text" class="form-class input2" id="mlh_name2" name="mlh_name" label="이름"></td>
					</tr>
					<tr>
						<th>나이</th>
						<td><input type="number" class="form-class input2" name="mlh_age" id="mlh_age2" label="나이" style="width:auto; float:left;"> <label style="position:relative;float:left; top:10px; left:10px;">세</label></td>
					</tr>
					<tr>
						<th>휴대전화</th>
						<td><input type="tel" class="form-class input2" name="mlh_mobileno" id="mlh_mobileno2" label="휴대전화"></td>
					</tr>
					<tr>
						<th>문의사항</th>
						<td>
							<textarea class="form-class input2" rows="5" id="mlh_text2" name="mlh_text" label="문의사항"></textarea>
						</td>
					</tr>
					<tr>
						<td colspan="2" class="t-center">
							<div class="checkbox">
								<input type="checkbox" name="" id="agree2" checked> <label for="agree">개인정보 수집 및 이용동의</label>
							</div>
						</td>
					</tr>
                    <tr>
					...
					<tr>
						<td colspan="2" class="t-center">
							<a name="mem_tenping" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_tenping2"><input type="image" img src="<?=$AD_DIR?>/images/btn1.png" style="max-width: 70%;"></a>
						</td>
					</tr>
				</tbody>
			</table>
		...
		<section><img src="<?=$AD_DIR?>/images/footer.gif" width="100%"></section>
	</div>
