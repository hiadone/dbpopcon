...
<body>
	<div class="container">
		...
		<section><img src="<?=$AD_DIR?>/images/db_top1.jpg"></section>
		<section id="inDB">
			<?php
			...
			<table>
				...
				<tbody>
					...
					<tr>
						<td colspan="2" class="t-center">
							<a name="mem_tenping" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_tenping"><input type="image" img src="<?=$AD_DIR?>/images/btn01.jpg" style="max-width: 100%;"></a>
						</td>
					</tr>
					<tr>
						<td colspan="2" class="t-center">
				...
				<tbody>
					...
					<tr>
						<td colspan="2" class="t-center" style="padding:10px 0;">
							<a name="mem_tenping" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_tenping"><input type="image" img src="<?=$AD_DIR?>/images/btn02.jpg" style="max-width: 100%;"></a>
						</td>
					</tr>
				</tbody>
			</table>
