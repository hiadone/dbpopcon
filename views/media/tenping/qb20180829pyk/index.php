...
<body>
	<div class="container">
		...
		<section><img src="<?=$AD_DIR?>/images/ani1.gif"></section>
		<section><img src="<?=$AD_DIR?>/images/a.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/ani2.gif"></section>
		<section><img src="<?=$AD_DIR?>/images/ani3.gif"></section>
		<section><img src="<?=$AD_DIR?>/images/b.jpg"></section>
		<section><a href="javascript:;" onclick="fnMove();"><img src="<?=$AD_DIR?>/images/btn12.jpg"></a></section>
		<section><img src="<?=$AD_DIR?>/images/c.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/d.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/ani4.gif"></section>
		<section><img src="<?=$AD_DIR?>/images/e.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/f.jpg"></section>
		<section><img src="<?=$AD_DIR?>/images/g.jpg"></section>
        <section class="inDB">
            <?php
            ...
            <input type="hidden" name="jid" value="<?php echo $jid?>">                  
				<table>
					...
					<tbody>
						...
						<tr>
							<th>나이</th>
							<td><input type="number" class="form-class input" name="mlh_age" id="mlh_age" label="나이"  style="width:auto; float:left;"> <label style="position:relative;float:left; top:6px; left:3px;">세</label></td>
						</tr>
						<tr>
							<th>연락처</th>
                ...
                <a name="mem_tenping" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_tenping"><input type="image" img src="<?=$AD_DIR?>/images/btn23.jpg" style="max-width: 100%;"></a>
				<?php echo form_close(); ?>
		</section>
		<section><img src="<?=$AD_DIR?>/images/h.jpg"></section>
	</div>
