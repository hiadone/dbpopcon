...
<script type="text/javascript">
    // var filter = "win16|win32|win64|mac|macintel|WinCE|HP-UX|SunOS";
    //  if( navigator.platform  ){
    //     if( filter.indexOf(navigator.platform.toLowerCase())<0 ){
    //     }else{ // pc 로 접속할 경우 아래 url 로 이동 및 히스토리 삭제
    //         window.location.replace('http://ad1.carione.kr/error/');
    //     }
    // }
</script>
...
var scrollTab = function (sObj) {
	...
	window.scrollTo( 0,$("#" + sObj).offset().top);
...
<body>
<div id="wrap" style="padding-bottom:12%; background-color: #000;">
	<div class="db_click"><a href="javascript:scrollTab('inDB');"><img src="<?=$AD_DIR?>/images/scroll_img.png" class="img100"></a></div>
	<div class="container">
		...
		<div class="a-center"><iframe width="94%" height="215" src="//www.youtube.com/embed/ZvZ7bEaAEDk?rel=0" frameborder="0" allowfullscreen></iframe></div>
		...
		<div class="img-area"><img src="<?=$AD_DIR?>/images/news006.gif" class="img100" style="display:block;"></div>
		<div class="img-area"><img src="<?=$AD_DIR?>/images/news007.gif" class="img100" style="display:block;"></div>
		...
		<div class="img-area"><a href="javascript:scrollTab('inDB');"><img src="<?=$AD_DIR?>/images/news013.jpg" class="img100" style="display:block;"></a></div>
        <div class="img-area"  id="inDB"><img src="<?=$AD_DIR?>/images/news014.jpg" class="img100" style="display:block;"></div>
		<div id="db"><img src="<?=$AD_DIR?>/images/db_top.jpg" class="img100" style="display:block;"></div>

        <div class="consult_wrap pt30" style="background-color:#000;">
            <div class="cont">
                <table class="consult1 width90">
					...
					<tr>
                            <td colspan="2" class="a-center" style="color:#fff;font-family: bold;">
                            <?php 
                            $comment='';
			...
			<?php if ($this->cbconfig->item('use_selfcert_phone')) { ?>
					<p class="a-center pb50"><a name="mem_selfcert" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_mem_selfcert_phone"><img src="<?=$AD_DIR?>/images/db_btn.png" class="img80"></a></p>
...
<!--
		<div class="label"><p>실시간정보</p><span></span></div>
		<ul class="crossAD">
			<li>
				<a href="http://ad1.newsissue.co.kr/?CODE_NAME=TRYCUTS20170322JSH&MEDIA_CODE=carione_banner" target="_blank"><img src="<?=$AD_DIR?>/images/006.jpg"></a>
				<p>문지르기만 하면 요요없이 -17kg 감량..업계발칵!</p>
			</li>
			<li>
				<a href="http://ad1.newsissue.co.kr/?CODE_NAME=TOURECELL0615&MEDIA_CODE=carione_banner" target="_blank"><img src="<?=$AD_DIR?>/images/003.jpg"></a>
				<p>수술없이 끼우기만 하니 女친 헐떡헐떡대..충격!</p>
			</li>
		</ul>
		<div class="img-area"><img src="<?=$AD_DIR?>/images/footer.jpg" class="img100" style="display:block;"></div>
