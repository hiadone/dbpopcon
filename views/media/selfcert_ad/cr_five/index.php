		...
		<div  class="consult_wrap" id="consult">
			<div class="cont">
				...
				<?php if ($this->cbconfig->item('use_selfcert_phone')) { ?>
					<p class="cr_btn a-center mb20"><a name="mem_selfcert" data-post_id="<?php echo element('post_id',element('post', $view));?>" id="btn_mem_selfcert_phone"><img src="<?=$AD_DIR?>/images/btn.gif" class="width80"></a></p>
