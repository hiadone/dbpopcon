...
<?php if ($this->cbconfig->item('use_selfcert') && $this->cbconfig->item('use_selfcert_required') && ($this->cbconfig->item('use_selfcert_phone') OR $this->cbconfig->item('use_selfcert_ipin'))) { ?>
